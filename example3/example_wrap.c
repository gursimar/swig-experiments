...
/* end header section */
/* vdecl subsection */
static int le_swig__p_intArray=0; /* handle for intArray */
...
ZEND_NAMED_FUNCTION(_wrap_new_intArray) {
  ...
  SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_intArray, 1);
...
static void __wrap_delete_intArray(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
  ...
  arg1 = (intArray *)SWIG_ZTS_ConvertResourceData(ptr,type_name,SWIGTYPE_p_intArray TSRMLS_CC);
  if (! arg1) zend_error(E_ERROR, "intArray resource already free'd");
...
ZEND_NAMED_FUNCTION(_wrap_intArray_getitem) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_intArray, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of intArray_getitem. Expected SWIGTYPE_p_intArray");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_intArray_setitem) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_intArray, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of intArray_setitem. Expected SWIGTYPE_p_intArray");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
...
ZEND_NAMED_FUNCTION(_wrap_intArray_cast) {
  intArray *arg1 = (intArray *) 0 ;
  zval **args[1];
  int *result = 0 ;
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_intArray, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of intArray_cast. Expected SWIGTYPE_p_intArray");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
...
ZEND_NAMED_FUNCTION(_wrap_intArray_frompointer) {
  int *arg1 = (int *) 0 ;
  zval **args[1];
  intArray *result = 0 ;
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_int, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of intArray_frompointer. Expected SWIGTYPE_p_int");
    }
  }
  result = (intArray *)intArray_frompointer(arg1);
  
  SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_intArray, 0);
...
ZEND_NAMED_FUNCTION(_wrap_arraySum) {
  int *arg1 = (int *) 0 ;
  int arg2 ;
  zval **args[2];
  int result;
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_int, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of arraySum. Expected SWIGTYPE_p_int");
    }
  }
...
static ZEND_RSRC_DTOR_FUNC(_wrap_destroy_p_intArray) {
  __wrap_delete_intArray(rsrc, SWIGTYPE_p_intArray->name TSRMLS_CC);
}
...
static zend_function_entry example_functions[] = {
 SWIG_ZEND_NAMED_FE(new_intarray,_wrap_new_intArray,NULL)
 SWIG_ZEND_NAMED_FE(intarray_getitem,_wrap_intArray_getitem,NULL)
 SWIG_ZEND_NAMED_FE(intarray_setitem,_wrap_intArray_setitem,NULL)
 SWIG_ZEND_NAMED_FE(intarray_cast,_wrap_intArray_cast,NULL)
 SWIG_ZEND_NAMED_FE(intarray_frompointer,_wrap_intArray_frompointer,NULL)
 SWIG_ZEND_NAMED_FE(arraysum,_wrap_arraySum,NULL)
...
le_swig__p_intArray=zend_register_list_destructors_ex(_wrap_destroy_p_intArray,NULL,(char *)(SWIGTYPE_p_intArray->name),module_number);
SWIG_TypeClientData(SWIGTYPE_p_intArray,&le_swig__p_intArray);
