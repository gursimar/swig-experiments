...
SWIGINTERN PyObject *_wrap_arraySum(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int *arg1 = (int *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:arraySum",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_int, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "arraySum" "', argument " "1"" of type '" "int *""'"); 
  }
  arg1 = (int *)(argp1);
  ecode2 = SWIG_AsVal_int(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "arraySum" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = (int)(val2);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"arraySum", _wrap_arraySum, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
